...
var World = {
	...
	loadPoisFromJsonData: function loadPoisFromJsonDataFn(poiData) {
		...
		for (var currentPlaceNr = 0; currentPlaceNr < poiData.length; currentPlaceNr++) {
		    console.log(poiData[currentPlaceNr].name + ", " + poiData[currentPlaceNr].image);
			var singlePoi = {
	...
	*/
	...
	onPoiDetailMoreButtonClicked: function onPoiDetailMoreButtonClickedFn() {
		...
		var architectSdkUrl = "architectsdk://markerselected?id=" + encodeURIComponent(currentMarker.poiData.id) + "&title=" + encodeURIComponent(currentMarker.poiData.title) + "&description=" + encodeURIComponent(currentMarker.poiData.description) + "&latitude=" + encodeURIComponent(currentMarker.poiData.latitude) + "&longitude=" + encodeURIComponent(currentMarker.poiData.longitude) + "&image=" + encodeURIComponent(currentMarker.poiData.image) + "&rating=" + encodeURIComponent(currentMarker.poiData.rating);
		/*
